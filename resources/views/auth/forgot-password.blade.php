...
<head>
    ...
    <title>Lupa Password - Koperasi Pramatech</title>
...
<body data-theme="light">
    ...
    <div id="successModal" class="success-modal-overlay">
        <div class="success-modal-content">
            ...
            <div class="success-modal-body">
                <p id="successMessage" class="text-sm" style="color: var(--text-secondary);">
                    Tautan reset password telah dikirim ke email Anda.
                </p>
            </div>
            <div class="success-modal-footer">
                <button id="closeSuccessModal" class="success-modal-btn success-modal-btn-primary">OK</button>
            </div>
        </div>
    </div>
    ...
    <div id="loadingOverlay" class="loading-overlay">
        <div class="loading-container">
            ...
            <p class="loading-text">Mengirim Email</p>
    ...
    <div class="form-container animate-slideUp">
        <div class="text-center mb-8">
            ...
            <p style="color: var(--text-secondary);">Lupa Password</p>
        </div>

        <div class="mb-6 text-sm" style="color: var(--text-secondary);">
            Lupa password? Tidak masalah. Cukup beri tahu kami alamat email Anda dan kami akan mengirimkan tautan reset password yang memungkinkan Anda memilih yang baru.
        </div>
                ...
                fetch(url, {
                    ...
                    .then(response => {
                        if (response.ok) {
                            ...
                            // Tampilkan success modal setelah 2.5 detik
                            setTimeout(() => {
                                loadingOverlay.classList.remove('active');
                                showSuccessModal('Tautan reset password telah dikirim ke email Anda.');
                                form.reset();
                            }, 2500);
                            return;
                        }
