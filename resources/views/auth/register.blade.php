...
<head>
    ...
    <title>Register - Koperasi Pramatech</title>
    ...
    <style>
        * {
        ...
        :root {
            ...
            --circle-gradient-1: #10b981;
            --circle-gradient-2: #059669;
            --circle-gradient-3: #6ee7b7;
        }
        ...
        [data-theme="dark"] {
            ...
            --circle-gradient-1: #34d399;
            --circle-gradient-2: #10b981;
            --circle-gradient-3: #6ee7b7;
        }
        ...
        .circle-1 {
            width: 300px;
            height: 300px;
            background: linear-gradient(45deg, var(--circle-gradient-1), #34d399);
            top: -100px;
            left: -100px;
        }
        ...
        .circle-2 {
            width: 200px;
            height: 200px;
            background: linear-gradient(45deg, var(--circle-gradient-2), var(--circle-gradient-1));
            bottom: -50px;
            right: -50px;
        }
        ...
        .circle-3 {
            width: 150px;
            height: 150px;
            background: linear-gradient(45deg, var(--circle-gradient-3), var(--circle-gradient-1));
            top: 50%;
            right: 10%;
        }
...
<body data-theme="light">
    ...
    <div id="validationErrorsModal" class="modal-overlay">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Register Error</h3>
            </div>
    ...
    <div id="loadingOverlay" class="loading-overlay">
        <div class="loading-container">
            ...
            <p class="loading-text">Membuat Akun</p>
    ...
    <div class="form-container animate-slideUp">
        <div class="text-center mb-8">
            ...
            <p style="color: var(--text-secondary);">Buat akun baru</p>
        </div>
                ...
                fetch(url, {
                    ...
                    .catch(error => {
                        if (error.errors) {
                            ...
                            showErrorModal(['Pendaftaran gagal. Coba lagi.']);
                        }
                    });
            });
        });
